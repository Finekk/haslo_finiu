...
--- CONFIG ---
password = "FiniuHaslo" -- Haslo jakie ma byc podczas wejscia
kickMessage = "Hasło znajdziesz na discordzie: https://discord.gg/XD" -- Wiadomosc po wpisaniu zlego hasla
